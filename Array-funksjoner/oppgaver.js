...
// Skriv koden din her:
const finnPopularitetOver85 = ordbok.find(ordbok => ordbok.popularitet > 85);
console.log(finnPopularitetOver85)
// console.log(finnPopularitetOver85.popularitet)
...
// Skriv koden din her:
const arrayMedOrd = ordbok.map(ordbok => ordbok.ord)
console.log(arrayMedOrd)
...
// Skriv koden din her:
const arrayMedAlt = ordbok.map(ordbok => ({
    ord: ordbok.ord,
